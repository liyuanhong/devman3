...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null,$upload_dir = null) {
        $this->options = array(
            ...
            'readfile_chunk_size' => 1 * 1024 * 1024, // 1 MiB
...
//        exit;
        if($upload_dir != null){
            $this->options["upload_dir"] = dirname($this->get_server_var('SCRIPT_FILENAME')).$upload_dir;
            $this->options["upload_url"] =  $this->get_full_url().$upload_dir;
        }
        if ($options) {
    ...
    public function post($print_response = true) {
        ...
        $this->theRes = $this->generate_response(
