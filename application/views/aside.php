      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>查看设备</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>反馈信息</a></li>
          </ul>
        </li>
        <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>日志查询</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>图片对比</a></li>
          </ul>
        </li>
        <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>系统教程</a></li>
